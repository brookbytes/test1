...
export default function CookerAutoclave() {
  const product = {
    title: "Cooker Autoclave",
    description: "Heavy-duty cooker autoclave designed for high-volume sterilization in dental clinics and hospitals. This robust sterilization unit features a large capacity chamber with advanced pressure control and safety systems, perfect for bulk instrument sterilization and surgical equipment processing.",
    features: [
      "Large capacity cooker-style chamber for bulk sterilization",
      "24-liter chamber capacity for high-volume processing",
      "Heavy-duty aluminum/stainless steel construction for durability",
      "Manual pressure control with safety valve system",
      "Traditional cooker design with modern safety features",
      "Fast heating with efficient steam generation",
      "Ideal for sterilizing surgical instruments and dental tools",
      "Simple operation with minimal training required",
      "Cost-effective solution for small to medium clinics",
      "Suitable for both wrapped and unwrapped instruments"
    ],
    specifications: {
      "Chamber Capacity": "24 Liters",
      "Sterilization Temperature": "121°C - 126°C",
      "Working Pressure": "1.1-1.5 bar",
      "Power Supply": "220V/50Hz Single Phase",
      "Power Consumption": "2000W",
      "Chamber Dimensions": "300mm x 350mm",
      "Overall Dimensions": "420mm x 420mm x 580mm",
      "Net Weight": "35 kg",
      "Material": "Heavy-duty Aluminum with SS components",
  ...
  return (
    <>
      <Head>
        <title>Cooker Autoclave - Premium Dental Sterilizer | Qualified Dental</title>
      ...
      <main className="product-detail-page">
        ...
        <div className="container">
          <div className="page-header">
            <h1>Cooker Autoclave</h1>
            <p>Autoclave designed for high-volume sterilization</p>
          </div>
